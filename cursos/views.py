...
class CursoViewSet(viewsets.ModelViewSet):
    ...
    def avaliacoes(self, request, pk=None):
        """
        Paginaçao Padrao nao funciona para essas funçoes personalizadas
        e necessario fazer na mao
        """
...
"""
Desse jeito eu posso setar quais methods eu quero pra esse serializer
no exemplo abaixo funciona tudo menos o delete
